...
import (
	...
	"github.com/Unotechsoftware/caddy/caddyfile"
	...
	_ "github.com/Unotechsoftware/caddy/caddyhttp" // plug in the HTTP server type
...
func getBuildModule() *debug.Module {
	...
	if ok {
		...
		for _, mod := range bi.Deps {
			if mod.Path == "github.com/Unotechsoftware/caddy" {
				return mod
			}
		}
	}
