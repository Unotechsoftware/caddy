...
You can have a direct impact on the project by helping with its code. To contribute code to Caddy, open a [pull request](https://github.com/Unotechsoftware/caddy/pulls) (PR). If you're new to our community, that's okay: **we gladly welcome pull requests from anyone, regardless of your native language or coding experience.** You can get familiar with Caddy's code base by using [code search at Sourcegraph](https://sourcegraph.com/github.com/Unotechsoftware/caddy/-/search).
...
1. [Fork this repo](https://github.com/Unotechsoftware/caddy). This makes a copy of the code you can write to.

2. If you don't already have this repo (Unotechsoftware/caddy.git) repo on your computer, get it with `go get github.com/Unotechsoftware/caddy/caddy`.

3. Tell git that it can push the Unotechsoftware/caddy.git repo to your fork by adding a remote: `git remote add myfork https://github.com/you/caddy.git`

4. Make your changes in the Unotechsoftware/caddy.git repo on your computer.

5. Push your changes to your fork: `git push myfork`

6. [Create a pull request](https://github.com/Unotechsoftware/caddy/pull/new/master) to merge your changes into Unotechsoftware/caddy @ master. (Click "compare across forks" and change the head fork.)
...
[Learn how to write and submit a plugin](https://github.com/Unotechsoftware/caddy/wiki) on the wiki. You should also share and discuss your plugin idea [on the forums](https://caddy.community) to have people test it out. We don't use the Caddy issue tracker for plugins.
...
Like every software, Caddy has its flaws. If you find one, [search the issues](https://github.com/Unotechsoftware/caddy/issues) to see if it has already been reported. If not, [open a new issue](https://github.com/Unotechsoftware/caddy/issues/new) and describe the bug, and somebody will look into it! (This repository is only for Caddy, not plugins.)
